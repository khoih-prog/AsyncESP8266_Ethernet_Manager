...
* [Why do we need this AsyncESP8266_Ethernet_Manager library](#why-do-we-need-this-async-AsyncESP8266_Ethernet_Manager-library)
  * [Features](#features)
...
* [Debug Terminal Output Samples](#debug-terminal-output-samples)
  * [1. Async_ConfigOnDoubleReset_TZ using LittleFS on ESP8266_NODEMCU_ESP12E with ESP8266_ENC28J60](#1-Async_ConfigOnDoubleReset_TZ-using-LittleFS-on-ESP8266_NODEMCU_ESP12E-with-ESP8266_ENC28J60)
  * [2. Async_ConfigOnSwichFS using LittleFS on ESP8266_NODEMCU_ESP12E with ESP8266_W5500](#2-Async_ConfigOnSwichFS-using-LittleFS-on-ESP8266_NODEMCU_ESP12E-with-ESP8266_W5500)
  * [3. Async_ESP_FSWebServer_DRD using LittleFS on ESP8266_NODEMCU_ESP12E with ESP8266_W5500](#3-Async_ESP_FSWebServer_DRD-using-LittleFS-on-ESP8266_NODEMCU_ESP12E-with-ESP8266_W5500)
  * [4. Async_ConfigOnDoubleReset_TZ using LittleFS on ESP8266_NODEMCU_ESP12E with ESP8266_W5100](#4-Async_ConfigOnDoubleReset_TZ-using-LittleFS-on-ESP8266_NODEMCU_ESP12E-with-ESP8266_W5100)
* [Debug](#debug)
...
### Why do we need this Async [AsyncESP8266_Ethernet_Manager library](https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager)
...
This [**AsyncESP8266_Ethernet_Manager** library](https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager) currently supports these following boards:
...
<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager/raw/main/Images/W5500.png">
</p>

<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager/raw/main/Images/W5500_small.png">
</p> 
...
<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager/raw/main/Images/Wiznet-Ethernet-Hat_RP2040.png">
</p> 
...
<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager/raw/main/Images/ENC28J60.png">
</p>
...
The best and easiest way is to use `Arduino Library Manager`. Search for `AsyncESP8266_Ethernet_Manager`, then select / install the latest version. You can also use this link [![arduino-library-badge](https://www.ardu-badge.com/badge/AsyncESP8266_Ethernet_Manager.svg?)](https://www.ardu-badge.com/AsyncESP8266_Ethernet_Manager) for more detailed instructions.

### Manual Install

1. Navigate to [AsyncESP8266_Ethernet_Manager](https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager) page.
2. Download the latest release `AsyncESP8266_Ethernet_Manager-main.zip`.
3. Extract the zip file to `AsyncESP8266_Ethernet_Manager-main` directory 
4. Copy the whole `AsyncESP8266_Ethernet_Manager-main` folder to Arduino libraries' directory such as `~/Arduino/libraries/`.

### VS Code & PlatformIO:

1. Install [VS Code](https://code.visualstudio.com/)
2. Install [PlatformIO](https://platformio.org/platformio-ide)
3. Install [**AsyncESP8266_Ethernet_Manager** library](https://registry.platformio.org/libraries/khoih-prog/AsyncESP8266_Ethernet_Manager) by using [Library Manager](https://registry.platformio.org/libraries/khoih-prog/AsyncESP8266_Ethernet_Manager/installation). Search for **AsyncESP8266_Ethernet_Manager** in [Platform.io Author's Libraries](https://platformio.org/lib/search?query=author:%22Khoi%20Hoang%22)
...
```cpp
#include <AsyncESP8266_Ethernet_Manager.hpp>        //https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager
```

in many files. But be sure to use the following `#include <AsyncESP8266_Ethernet_Manager.h>` **in just 1 `.h`, `.cpp` or `.ino` file**, which must **not be included in any other file**, to avoid `Multiple Definitions` Linker Error

```cpp
// To be included only in main(), .ino with setup() to avoid `Multiple Definitions` Linker Error
#include <AsyncESP8266_Ethernet_Manager.h>          //https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager
```

Have a look at the discussion in [Different behaviour using the src_cpp or src_h lib #80](https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager/discussions/80)
...
// Must be placed before #include <AsyncESP8266_Ethernet_Manager.h>
...
/******************************************
   // Defined in AsyncESP8266_Ethernet_Manager.hpp
  typedef struct
  {
...
```cpp
//AsyncESP8266_Ethernet_manager.setSTAStaticIPConfig(stationIP, gatewayIP, netMask, dns1IP, dns2IP);
AsyncESP8266_Ethernet_manager.setSTAStaticIPConfig(WM_STA_IPconfig);
```
...
```cpp
String tempTZ = AsyncESP8266_Ethernet_manager.getTimezoneName();
```
...
```cpp
const char * TZ_Result = AsyncESP8266_Ethernet_manager.getTZ(_timezoneName);
```
...
```cpp
AsyncESP8266_Ethernet_manager.startConfigPortal()
```
...
These illustrating steps is based on the example [Async_ConfigOnSwitchFS](https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager/tree/main/examples/Async_ConfigOnSwitchFS)
...
The example [Async_ConfigOnSwitchFS](https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager/tree/main/examples/Async_ConfigOnSwitchFS) will open the CP whenever a SW press is detected in `loop()`. So the code to add `dynamic variables` will be there, just after the CP `AsyncESP8266_Ethernet_Manager` class initialization to create `AsyncESP8266_Ethernet_Manager` object.
...
Adding those `ESPAsync_EMParameter` objects created in Step 2 using the function `addParameter()` of object `AsyncESP8266_Ethernet_Manager`
...
AsyncESP8266_Ethernet_manager.addParameter(&p_thingspeakApiKey);
AsyncESP8266_Ethernet_manager.addParameter(&p_sensorDht22);
AsyncESP8266_Ethernet_manager.addParameter(&p_pinSda);
AsyncESP8266_Ethernet_manager.addParameter(&p_pinScl);
```
...
After users select `Save`, the CP `AsyncESP8266_Ethernet_Manager` object will save the user input data into related `ESPAsync_EMParameter` objects.
...
<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager/raw/main/Images/Main.png">
</p>

Select `Information` to enter the Info page where the board info will be shown (long page)

<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager/raw/main/Images/Info.png">
</p>
...
<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager/raw/main/Images/Configuration_Standard.png">
</p>
...
<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager/raw/main/Images/Saved.png">
</p>
...
```cpp
AsyncESP8266_Ethernet_manager.setSaveConfigCallback(saveConfigCallback);
```
...
```cpp
AsyncESP8266_Ethernet_manager.setConfigPortalTimeout(120);
```
...
void loop()
{
  ...
  if ((digitalRead(TRIGGER_PIN) == LOW) || (digitalRead(TRIGGER_PIN2) == LOW))
  {
    ...
    AsyncESP8266_Ethernet_Manager AsyncESP8266_Ethernet_manager(&webServer, &dnsServer, "ConfigOnSwitch");
    ...
    AsyncESP8266_Ethernet_manager.setSTAStaticIPConfig(stationIP, gatewayIP, netMask);
#endif
#endif
    ...
    if (loadConfigData())
    {
      AsyncESP8266_Ethernet_manager.setConfigPortalTimeout(
    ...
    else
    {
      ...
      AsyncESP8266_Ethernet_manager.setConfigPortalTimeout(0);
    ...
    if (!AsyncESP8266_Ethernet_manager.startConfigPortal())
    ...
    const char * TZ_Result = AsyncESP8266_Ethernet_manager.getTZ(Ethconfig.TZ_Name);
    ...
    AsyncESP8266_Ethernet_manager.getSTAStaticIPConfig(EthSTA_IPconfig);
...
Many applications need configuration parameters like `MQTT host and port`, [Blynk](http://www.blynk.cc) or [emoncms](http://emoncms.org) tokens, etc. While it is possible to use [`AsyncESP8266_Ethernet_Manager`](https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager) to collect additional parameters, it is better to read these parameters from a web service once [`AsyncESP8266_Ethernet_Manager`](https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager) has been used to connect to the Internet.

To capture other parameters with [`AsyncESP8266_Ethernet_Manager`](https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager) is a little bit more complicated than all the other features. This requires adding custom HTML to your form. 

If you want to do it with [`AsyncESP8266_Ethernet_Manager`](https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager) see the example [Async_ConfigOnSwitchFS](examples/Async_ConfigOnSwitchFS)
...
```cpp
AsyncESP8266_Ethernet_manager.setSTAStaticIPConfig(IPAddress(192,168,2,186), IPAddress(192,168,2,1), IPAddress(255,255,255,0));
```
...
```cpp
AsyncESP8266_Ethernet_manager.setCustomHeadElement("<style>html{filter: invert(100%); -webkit-filter: invert(100%);}</style>");
```
...
AsyncESP8266_Ethernet_manager.addParameter(&custom_text);
```
...
https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager/blob/befc3b418ad3ba1edb02a81bb68c351ac8bdf688/examples/Async_ConfigOnSwitch/Async_ConfigOnSwitch.ino#L28-L819
...
#### 1. Async_ConfigOnDoubleReset_TZ using LittleFS on ESP8266_NODEMCU_ESP12E with ESP8266_ENC28J60

##### 1.1 DRD => Config Portal

This is terminal debug output when running [Async_ConfigOnDoubleReset_TZ](examples/Async_ConfigOnDoubleReset_TZ) on  **ESP8266_ENC28J60**. `Config Portal` was requested by DRD to input and save Credentials, such as Static IP address.

```
Starting Async_ConfigOnDoubleReset_TZ using LittleFS on ESP8266_NODEMCU_ESP12E with ESP8266_ENC28J60 Ethernet
AsyncESP8266_Ethernet_Manager v1.0.0
...
[EM] dns1IP = 192.168.2.1 , dns2IP = 8.8.8.8
[EM] OK
Current IP = 192.168.2.119. Reset to take new IP = 192.168.2.188
...
Saving config file...
Saving config file OK
Local Date/Time: Mon Dec 12 21:10:17 2022
Local Date/Time: Mon Dec 12 21:11:17 2022
Local Date/Time: Mon Dec 12 21:12:17 2022
Local Date/Time: Mon Dec 12 21:13:17 2022
Local Date/Time: Mon Dec 12 21:14:17 2022
```
...
This is terminal debug output when running [Async_ConfigOnSwichFS](examples/Async_ConfigOnSwichFS) on  **ESP8266_W5500**. `Config Portal` was requested to input and save Credentials.
...
[EM] freeing allocated params!
Local Date/Time: Mon Dec 12 21:15:17 2022
Local Date/Time: Mon Dec 12 21:16:17 2022
Local Date/Time: Mon Dec 12 21:17:17 2022
Local Date/Time: Mon Dec 12 21:18:17 2022
```
...
This is terminal debug output when running [Async_ESP_FSWebServer_DRD](examples/Async_ESP_FSWebServer_DRD)  on  **ESP8266_W5500**. `Config Portal` was requested by DRD (also using **LittleFS**) to input and save Credentials.
...
#### 4. Async_ConfigOnDoubleReset_TZ using LittleFS on ESP8266_NODEMCU_ESP12E with ESP8266_W5100


This is terminal debug output when running [Async_ConfigOnDoubleReset_TZ](examples/Async_ConfigOnDoubleReset_TZ) on  **ESP8266_W5100**.
...
```cpp
AsyncESP8266_Ethernet_manager.setDebugOutput(false);
```
...
Submit issues to: [AsyncESP8266_Ethernet_Manager issues](https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager/issues)
...
- The library is licensed under [MIT](https://github.com/khoih-prog/AsyncESP8266_Ethernet_Manager/blob/main/LICENSE)
