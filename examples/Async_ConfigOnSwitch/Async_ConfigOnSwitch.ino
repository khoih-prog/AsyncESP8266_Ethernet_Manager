...
#if !( defined(ESP8266) )
  #error This code is intended to run on the (ESP8266 + W5500 / W5100(S) / ENC28J60) platform! Please check your Tools->Board setting.
#endif
...
void setup()
{
  ...
  Serial.println(ASYNC_ESP8266_ETH_MANAGER_VERSION);
  ...
  AsyncESP8266_Ethernet_Manager AsyncESP8266_Ethernet_manager(&webServer, NULL, "AsyncConfigOnSwitch");
#else
  AsyncDNSServer dnsServer;

  AsyncESP8266_Ethernet_Manager AsyncESP8266_Ethernet_manager(&webServer, &dnsServer, "AsyncConfigOnSwitch");
#endif

  AsyncESP8266_Ethernet_manager.setDebugOutput(true);

#if !USE_DHCP_IP
  // Set (static IP, Gateway, Subnetmask, DNS1 and DNS2) or (IP, Gateway, Subnetmask)
  AsyncESP8266_Ethernet_manager.setSTAStaticIPConfig(EthSTA_IPconfig);
#endif
  ...
  if (initialConfig)
  {
    ...
    //AsyncESP8266_Ethernet_manager.setConfigPortalTimeout(600);
...
#if ( USING_ESP32_S2 || USING_ESP32_C3 )
    AsyncESP8266_Ethernet_Manager AsyncESP8266_Ethernet_manager(&webServer, NULL, "ConfigOnSwitch");
#else
    AsyncDNSServer dnsServer;
