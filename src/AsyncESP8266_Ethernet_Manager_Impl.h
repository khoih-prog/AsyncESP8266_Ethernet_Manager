...
void AsyncESP8266_Ethernet_Manager::handleState(AsyncWebServerRequest *request)
{
...
void AsyncESP8266_Ethernet_Manager::handleReset(AsyncWebServerRequest *request)
{
  LOGDEBUG(F("Reset"));
...
void AsyncESP8266_Ethernet_Manager::handleNotFound(AsyncWebServerRequest *request)
{
  if (captivePortal(request))
  {
...
*/
bool AsyncESP8266_Ethernet_Manager::captivePortal(AsyncWebServerRequest *request)
{
...
void AsyncESP8266_Ethernet_Manager::setSaveConfigCallback(void(*func)())
{
  _savecallback = func;
}
...
void AsyncESP8266_Ethernet_Manager::setCustomHeadElement(const char* element)
{
...
// Is this an IP?
bool AsyncESP8266_Ethernet_Manager::isIp(const String& str)
{
...
// IP to String
String AsyncESP8266_Ethernet_Manager::toStringIp(const IPAddress& ip)
{
  String res = "";
...
#endif    // AsyncESP8266_Ethernet_Manager_Impl_h
