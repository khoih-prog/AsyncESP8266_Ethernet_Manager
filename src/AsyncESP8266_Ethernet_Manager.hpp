/****************************************************************************************************************************
  AsyncESP8266_Ethernet_Manager.hpp
...
#ifndef AsyncESP8266_Ethernet_Manager_hpp
#define AsyncESP8266_Ethernet_Manager_hpp

#if !( defined(ESP8266) )
  #error This code is intended to run on the (ESP8266 with W5x00 or ENC28J60) platform! Please check your Tools->Board setting.
#endif

////////////////////////////////////////////////////

#define ASYNC_ESP8266_ETH_MANAGER_VERSION           "AsyncESP8266_Ethernet_Manager v1.0.0"

#define ASYNC_ESP8266_ETH_MANAGER_VERSION_MAJOR     1
#define ASYNC_ESP8266_ETH_MANAGER_VERSION_MINOR     0
#define ASYNC_ESP8266_ETH_MANAGER_VERSION_PATCH     0

#define ASYNC_ESP8266_ETH_MANAGER_VERSION_INT       1000000
...
#include "AsyncESP8266_Ethernet_Manager_Debug.h"
...
#if !defined(USING_W5100)
	#define USING_W5100         	false
#endif

#if !defined(USING_ENC28J60)
	#define USING_ENC28J60         false
#endif

#if (!USING_W5500 && !USING_W5100 && !USING_ENC28J60)
	#undef USING_W5500
...
#else		// #if USE_ESP_ETH_MANAGER_NTP
...
#endif	// #if USE_ESP_ETH_MANAGER_NTP
...
#if ( (_ESPASYNC_ETH_MGR_LOGLEVEL_ > 3) && DISPLAY_STORED_CREDENTIALS_IN_CP )
...
class ESPAsync_EMParameter 
{
  ...
  private:
    ...
    friend class AsyncESP8266_Ethernet_Manager;
};
...
class AsyncESP8266_Ethernet_Manager
{
  public:

    AsyncESP8266_Ethernet_Manager(AsyncWebServer * webserver, AsyncDNSServer *dnsserver, const char *iHostname = "");
...
#endif    // AsyncESP8266_Ethernet_Manager_hpp
